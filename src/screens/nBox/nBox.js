            ...
            <View style={styles.container}>
                ...
                <View style={styles.SwitchView}>
                    ...
                    >
                        ...
                        <View style={[{ flex: .4, width: '100%', marginTop: 5 }, chatSwtich ? { backgroundColor: '#FFF' } : { backgroundColor: Green }]}></View>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.SwitchSubView}
                    ...
                    >
                        ...
                        <View style={[{ flex: .4, width: '100%', marginTop: 5 }, chatSwtich ? { backgroundColor: Blue } : { backgroundColor: '#FFF' }]}></View>
                    </TouchableOpacity>
                </View>
                <Searchbar
                    placeholder="Search"
